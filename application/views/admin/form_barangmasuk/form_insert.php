  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="<?php echo base_url('admin') ?>" class="logo">
        ...
        <span class="logo-lg"><b>SH</b>ASSET</span>
      </a>
                  ...
                  <form action="<?= base_url('admin/proses_databarang_masuk_insert') ?>" role="form" method="post">
                    ...
                    <div class="box-body">
                      <div class="form-group">
                        ...
                        <input type="text" name="id_transaksi" style="margin-left:37px;width:20%;display:inline;" class="form-control"; ?>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group" style="margin-bottom:40px;">
                        ...
                        <select class="form-control" name="lokasi" style="margin-left:75px;width:20%;display:inline;">
                          ...
                          <option value="Aceh">SOFYAN HOTEL BETAWI</option>
                          <option value="Bali">SOFYAN HOTEL SOEPOMO</option>
                          <option value="Bengkulu">SALEROKU-BETAWI</option>
                          <option value="Bengkulu">SENGKOELOEN-BETAWI</option>
                          <option value="Jakarta">SENGKOELOEN-SOEPOMOM</option>
                          <option value="Jambi">GRAHA SOFYAN</option>
                          <option value="Jawa Tengah">ARVAHUB-GONDANGDIA</option>
                          <option value="Jawa Timur">ARVAHUB-SOEPOMO</option>
                          <option value="Jawa Barat">ARVO-CIKINI</option>
                        </select>
                      </div>
